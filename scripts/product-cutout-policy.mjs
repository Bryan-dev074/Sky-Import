...
export const PRODUCT_CUTOUT_POLICY = Object.freeze({
  ...
  'radeon-rx-9070-xt-16gb': reviewedEnlargementPolicy(1.477),
  ...
  'asus-tuf-gaming-b650-plus-wifi': reviewedEnlargementPolicy(1.668),
  'msi-pro-b650m-a-wifi': reviewedEnlargementPolicy(1.9),
  'asrock-z890-pro-rs': reviewedEnlargementPolicy(1.904),
  ...
  'msi-mag-a650bn': reviewedEnlargementPolicy(1.523),
  'noctua-nh-d15': DEFAULT_PRODUCT_CUTOUT_POLICY,
  'thermalright-peerless-assassin-120-se': reviewedEnlargementPolicy(1.79),
  'arctic-liquid-freezer-iii-360': DEFAULT_PRODUCT_CUTOUT_POLICY,
  'lian-li-lancool-216': reviewedEnlargementPolicy(1.93),
  'nzxt-h5-flow': DEFAULT_PRODUCT_CUTOUT_POLICY,
  'cooler-master-masterbox-q300l': reviewedEnlargementPolicy(1.524),
